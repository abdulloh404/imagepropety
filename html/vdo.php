...
<body>
        ...
        <div class="row">
            <div class="col-lg-7">
                <div class="card">
                    <div class="card-body">
                        <div class="container">
                            <iframe width="100%" height="448" 
                                src="https://www.youtube.com/embed/QRNqve9aM2Y" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                            </iframe>
                        </div>
                                ...
                                <div class="container-fluid">
                                    <div class="text-center mt-5">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#Modal1">
                                            <img src="./assets/img/murder.jpg" alt="" class="vdotitle">
                                ...
                                <div class="container-fluid">
                                    <div class="text-center mt-5">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#Modal2">
                                            <img src="./assets/img/samsung.png" alt="" class="vdotitle">
                                ...
                                <div class="container-fluid">
                                    <div class="text-center mt-5">
                                        <a href="#" href="#" data-bs-toggle="modal" data-bs-target="#Modal3">
                                            <img src="./assets/img/kla.png" alt="" class="vdotitle">
                                ...
                                <div class="container-fluid">
                                    <div class="text-center mt-5">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#Modal4">
                                            <img src="./assets/img/gsb.png" alt="" class="vdotitle">
    ...
    <div class="container">
        <div style="text-align: center;">
            <a href="#" role="button" class="btn btn-warning btn-lg text-white">อ่านต่อ คลิ๊ก!</a>
        </div>
    </div>
    <br>
