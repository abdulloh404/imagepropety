				...
				<div class="col-md-6 col-lg-6 col-xl-7 d-none d-md-flex bg-warning-transparent">
					<div class="row wd-100p mx-auto text-center">
						<div class="col-md-12 col-lg-12 col-xl-12 my-auto mx-auto wd-100p">
							<img src="admin/assets/img/website-gceeb54b7b_1280.png" class="my-auto ht-xl-80p wd-md-100p wd-xl-50p ht-xl-60p mx-auto" alt="logo">
						</div>
					</div>
				</div>
				<!-- The content half -->
									...
									<div class="main-card-signin d-md-flex">
										<div class="wd-100p">
											<div class="main-signin-header">
												<div class="">
													<h1 class="text-warning">Welcome back!</h1>
													<h4 class="text-start">Reset Your Password</h4>
													<form method="POST" action="">
														<?php echo $secret ?>
														<div class="form-group text-start">
															<label>OTP Ref.</label> <span class="text-danger" data-name="otp">*</span>
															<input class="form-control" placeholder="OTP Here..." type="text" name="otp">
														</div>
														<div class="form-group text-start">
															<label>New Password</label> <span class="text-danger" data-name="newPassword">*</span>
															<input class="form-control" placeholder="Enter your password" type="password" name="newPassword">
														</div>
														<div class="form-group text-start">
															<label>Confirm Password</label> <span class="text-danger" data-name="comfirmPassword">*</span>
															<input class="form-control" placeholder="Enter your password" type="password" name="comfirmPassword">
														</div>
														<button class="btn ripple btn-warning btn-block reset_submit">Reset Password</button>
													</form>
												</div>
											</div>
											<div class="main-signup-footer mg-t-20">
												<p>Already have an account? <a href="<?php echo front_link(116) ?>">Sign In</a></p>
											</div>
										</div>
									</div>
								</div>
