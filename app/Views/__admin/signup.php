					...
					<div class="col-md-6 col-lg-6 col-xl-7 d-none d-md-flex bg-warning-transparent">
						<div class="row wd-100p mx-auto text-center">
							<div class="col-md-12 col-lg-12 col-xl-12 my-auto mx-auto wd-100p">
								<img src="admin/assets/img/handshake-close-up-executives.jpg" style="border-radius: 20px;" class="my-auto ht-xl-80p wd-md-100p wd-xl-80p mx-auto" alt="logo">
							</div>
						</div>
					</div>
					<!-- The content half -->
									...
									<div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
										<div class="card-sigin">
											<div class="main-signup-header">
												<h1 class="text-warning">Create an Account</h1>
												...
												<form action="#">
													...
													</div><button class="btn btn-warning btn-block">Create Account</button>
												</form>
