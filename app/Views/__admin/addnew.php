					...
					<div class="card-body">
						<div class="card  box-shadow-0">
							...
							<div class="card-body pt-0">
								...
								<form action="http://fm91/addnew/editvideo" method="post" class="form-horizontal">
									<?php echo $secret ?>

									<div class="form-group">
										<label>หัวเรื่องย่อย</label>
										<input type="text" class="form-control" id="" placeholder="หัวเรื่องย่อย">
									</div>
									<div class="form-group">
										<label>หมวดหมู่</label>
										<input type="text" class="form-control" id="" placeholder="หมวดหมู่">
									</div>
									<div class="form-group">
											...
											<div class="col-lg-12 col-md-12">
												<div class="card">
													<div class="card-body">
														...
														<p class="mg-b-20">It is Very Easy to Customize and it uses in
														...
														<div class="ql-wrapper ql-wrapper-demo bg-gray-100">
															<div class="ql-toolbar ql-snow"><span class="ql-formats"><span class="ql-header ql-picker"><span class="ql-picker-label" tabindex="0" role="button" aria-expanded="false" aria-controls="ql-picker-options-0"><svg viewBox="0 0 18 18">
																			...
																			</svg></span><span class="ql-picker-options" aria-hidden="true" tabindex="-1" id="ql-picker-options-0"><span tabindex="0" role="button" class="ql-picker-item" data-value="1"></span><span tabindex="0" role="button" class="ql-picker-item" data-value="2"></span><span tabindex="0" role="button" class="ql-picker-item" data-value="3"></span><span tabindex="0" role="button" class="ql-picker-item" data-value="4"></span><span tabindex="0" role="button" class="ql-picker-item" data-value="5"></span><span tabindex="0" role="button" class="ql-picker-item" data-value="6"></span><span tabindex="0" role="button" class="ql-picker-item ql-selected"></span></span></span><select class="ql-header" style="display: none;">
																	...
																	</select></span><span class="ql-formats"><button type="button" class="ql-bold"><i class="la la-bold" aria-hidden="true"></i></button><button type="button" class="ql-italic"><i class="la la-italic" aria-hidden="true"></i></button><button type="button" class="ql-underline"><i class="la la-underline" aria-hidden="true"></i></button><button type="button" class="ql-strike"><i class="la la-strikethrough" aria-hidden="true"></i></button></span><span class="ql-formats"><button type="button" class="ql-list" value="ordered"><i class="la la-list-ol" aria-hidden="true"></i></button><button type="button" class="ql-list" value="bullet"><i class="la la-list-ul" aria-hidden="true"></i></button></span><span class="ql-formats"><button type="button" class="ql-link"><i class="la la-link" aria-hidden="true"></i></button><button type="button" class="ql-image"><i class="la la-image" aria-hidden="true"></i></button><button type="button" class="ql-video"><i class="la la-film" aria-hidden="true"></i></button></span>
															</div>
															<div id="quillEditor" class="ql-container ql-snow">
																<div class="ql-editor" data-gramm="false" contenteditable="true">
																	<p><strong>Quill</strong> is a free, open source <a href="https://github.com/quilljs/quill/" target="_blank">WYSIWYG editor</a> built for
																		the modern web. With its <a href="https://quilljs.com/docs/modules/" target="_blank">modular architecture</a> and
																		expressive API, it is completely customizable to
																		fit any need.</p>
																	<p><br></p>
																	<p>The icons use here as a replacement to default
																		svg icons are from <a href="https://icons8.com/line-awesome" target="_blank">Line Awesome Icons</a>.</p>
																</div>
																<div class="ql-clipboard" contenteditable="true" tabindex="-1"></div>
																<div class="ql-tooltip ql-hidden"><a class="ql-preview" target="_blank" href="about:blank"></a><input type="text" data-formula="e=mc^2" data-link="https://quilljs.com" data-video="Embed URL"><a class="ql-action"></a><a class="ql-remove"></a>
																</div>
															</div>
														</div>
													</div>
									...
									<label>กำหนดเผยแพร่เนื้อหา</label>
									<div class="row row-sm" mt-3>
										<div class="input-group col-md-4">
											...
											</div><input class="form-control" id="datetimepicker2" type="text" placeholder="MM/DD/YYYY">
										</div>
									</div>


									<label class="mt-3">เผยแพร่เนื้อหา</label>
									<div class="main-toggle-group-demo">
										<div class="main-toggle on" style="background-color: #FDD400;">
											<span></span>
										</div>
									</div>
									...
									<div class="form-group mb-0 mt-3 justify-content-end">
										<div>
											<button type="submit" class="btn btn-primary" style="background-color: #FDD400;">เพิ่มข่าว</button>
