        ...
        <div class="row">
            ...
            <div class="col-md-8 load-form">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <h1 style="text-align: center;  margin: 20px">FORGOT PASSWORD</h1>
                        <hr style="border: 3px black solid;"><br>
                        <form action="" method="post" id="form_login" class="formSubmit">
                            <?php echo $secret ?>
                            <h3>กรุณากรอกอีเมลเพื่อเริ่มการตั้งค่ารหัสผ่านใหม่</h3>
                            <br/>
                            <input type="hidden" name="resetPass" value="1"></input>
                            <div id="email_input">
