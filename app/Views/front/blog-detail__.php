...
<link rel="stylesheet" href="page/assets/css/blog-detail.css">
        ...
        <div class="card border-0">
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-4 col-md-6 col mb-2">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            <img src="page/assets/img/001.png" class="size-profile" alt="">
                            <div class="ms-3">
                ...
                <div class="icon-share">
                    ...
                    <a href="" onclick="facebook()"><img src="page/assets/img/logo-fb.png" alt=""></a>
                    <a href=""><img src="page/assets/img/logo-line.png" alt=""></a>
                </div>
                <?php /*  <div id="box">
                    <button id="btn">
