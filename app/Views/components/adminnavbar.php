...
<nav class="navbar navbar-expand-lg bg-light"
    ...
    <div class="container">
        <div class="left-item-nav">
            <button class="btn-menu" type="button" data-bs-toggle="offcanvas" data-bs-target="#menuOffcanvas"
                aria-controls="menuOffcanvas">
                <i class="fas fa-bars"></i>
            </button>
            <a class="navbar-brand" href="<?php echo front_link(1) ?>"><img src="page/admin-assets/img/logo.png" alt=""
                    width="100px" height="45px"></a>
        </div>
        <div class="d-flex">
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="menuOffcanvas" aria-labelledby="offcanvasExampleLabel">
    ...
    <div class="offcanvas-body">
        ...
        <ul class="side-menus">
            ...
            <li><a href="<?php echo front_link(22) ?>"><i class="fas fa-image"></i>&nbsp; จัดการแบนเนอร์</a></li>
