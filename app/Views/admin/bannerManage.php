                ...
                <table id="dataTable" class="display nowrap pt-2" style="width:100%">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><a class="btn btn-sm btn-success btn-edit" href="bannerEdit.php"><i class="fas fa-edit"></i></a><button class="btn btn-sm btn-danger btn-del"><i class="fas fa-trash-alt"></i></button></td>
                        </tr>
                        <tr>
                            <td>2</td>
                            <td>
