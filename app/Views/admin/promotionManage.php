...
<style>
    ...
    <div class="container fit-height">
        ...
        <div class="row">
            <div class="col-12">
                <a href="promotionAdd.php" class="btn-add-blog">
                    เพิ่มโปรโมชัน
                </a>
            </div>
                ...
                <table id="dataTable" class="display nowrap pt-2" style="width:100%">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>2.39</td>
                            <td>จอหอ-บายพาส</td>
                            <td><a class="btn btn-sm btn-success btn-edit" href="promotionEdit.php"><i class="fas fa-edit"></i></a><button class="btn btn-sm btn-danger btn-del"><i class="fas fa-trash-alt"></i></button></td>
                        </tr>
                        <tr>
                            <td>2</td>
                            <td>
